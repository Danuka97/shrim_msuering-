...
if uploaded_file is not None:
    ...
    for i in range(xyxy.shape[0]):
        ...
        0.002*object_width^4 - 0.0578*object_width^3 + 0.7526*object_width^2 - 3.5356*object_width + 5.8716
        if option== 'W':
        ...
        cv2.putText(image, "{} cm".format(round(object_width, 1)), (int(x1 - 50), int(y1 + 120)), cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 0), 5)
        cv2.putText(image, "{} g".format(round(object_weight, 1)), (int(x1 - 50), int(y1 + 160)), cv2.FONT_HERSHEY_PLAIN, 3, (0, 255, 0), 5)
        cv2.putText(image, "{} count".format(round(object_count, 1)), (int(x1 - 50), int(y1 + 190)), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 3)
