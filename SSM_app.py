...
if uploaded_file is not None:
    ...
    for i in range(xyxy.shape[0]):
        ...
        cv2.putText(image, "{} g".format(round(object_weight, 1)), (int(x1 - 50), int(y1 + 185)), cv2.FONT_HERSHEY_PLAIN, 5, (255, 0, 0), 6)
        cv2.putText(image, "{} count".format(round(object_count, 1)), (int(x1 - 50), int(y1 + 235)), cv2.FONT_HERSHEY_PLAIN, 5, (255, 0, 0), 6)
        cv2.putText(image, "{} pdg".format(round(PDG, 1)), (int(x1 - 50), int(y1 + 265)), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 3)
